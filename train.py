...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", "-d", type=str, default="nell_v1",
                        help="Dataset string")
    ...
    parser.add_argument('--add_pt_emb', '-pt', type=bool, default=True,
                        help='whether to concatenate path embedding with pooled graph representation')
    parser.add_argument('--has_attn', '-attn', type=bool, default=True,
                        help='whether to have attn in model or not')
    parser.add_argument('--self_attn', '-st', type=bool, default=True,
                        help='whether to have self attn in model or not')
