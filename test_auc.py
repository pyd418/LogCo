...
def main(params):
    ...
    for r in range(1, params.runs + 1):
        ...
        if(result['auc_pr'] > max_result_aucpr):
            max_result_aucpr = result['auc_pr']

        logging.info('\nMax Auc_Pr:' + str(max_result_aucpr))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--experiment_name", "-e", type=str, default="wn_v4_test",
                        help="A folder with this name would be created to dump saved models and log files")
    parser.add_argument("--dataset", "-d", type=str, default="WN18RR_v4_ind",
                        help="Dataset string")
